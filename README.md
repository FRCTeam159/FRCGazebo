...
<h3>Running the program</h3>
 <h4> Teleop Mode</h4>
   <ol>
      ...
      <li>you can reset the initial scene by presing the reset checkbox in SmartDashboard or "Edit->Reset Model Poses" from the Gazebo menu bar
   </ol>
 <h4>Autonomous Mode</h4>
   <ol>
     ...
     <li>before running an auto routine press the "reset" checkbox to reset the model poses"
   ...
   <li> plotting support and other utilities is provided by java files in [root]/gztest/java/utils directory.
   </ol>
 <h4>Recording a video</h4>
   ...
   <li>the contents of this window can be captured into a vidio file (avi format) by pressing the "record" checkbox in the smartdashboard window
