...
public class TurnAround extends CommandBase {
  ...
  public TurnAround(Drivetrain drive, double dir) {
    m_drive=drive;
  ...
  public void initialize() {
    ...
    if(debug)    
      System.out.format("%s turn started current:%-3.1f target:%-3.1f %s\n",
        direction<0?"LEFT":"RIGHT",start_phase,target_angle+start_phase,target_angle>0?"CW":"CCW");
  }
